...
//让Web服务器监听的指定的端口上
let port=5050
app.listen(port,()=>{//提示：此处在为新浪云服务器做铺垫
 ...
 */
app.get('/course/newset',(req,res)=>{
	//向数据库服务器发送查询请求，获得必须的课程数据:前12条(即从第0行开始读取12行)：且最新课程（即按课程编号由大到小排序）:同时查询course和teacher两个表
